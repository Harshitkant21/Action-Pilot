  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md glass-panel p-8 relative z-10">
        ...
        <h3 className="text-xl font-semibold text-white mb-6 text-center font-outfit">Sign In</h3>
        ...
        <p className="mt-8 text-center text-sm text-dark-muted">
          ...
          <Link to="/register" className="text-dark-accent hover:underline transition font-semibold">
            Create Account
          </Link>
        </p>
      </div>
